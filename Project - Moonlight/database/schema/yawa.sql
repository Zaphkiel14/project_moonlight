...
create table Store_branch(
	store_branch_id int  primary key auto_increment,
...
-- Table: Users (Updated with Foreign Keys)
CREATE TABLE users (
...
CREATE TABLE prices (
    ...
    item_id int  NULL,            -- Item ID (used only for item-size pricing)
    size_id int  NULL,            -- Size ID (used only for item-size pricing)
    addon_id int  NULL,           -- Addon ID (used only for addon pricing)
...
CREATE TABLE order_item_addons (
    order_item_addon_id int  PRIMARY KEY AUTO_INCREMENT,
    order_item_id int  NOT NULL, -- Reference to the specific order item
    addon_id int  NOT NULL,      -- Reference to the specific addon
...
CREATE TABLE item_addons (
    item_addon_id int  PRIMARY KEY AUTO_INCREMENT,
    item_id int ,
    addon_id int ,
...
CREATE TABLE inventory (
    ...
    ingredient_id int  NULL,       -- Ingredient ID (used only for ingredients)
    addon_id int  NULL,            -- Addon ID (used only for addons)
...
create table customer_feedback(
	customer_feedback_id int  primary key auto_increment,
    order_id int ,
